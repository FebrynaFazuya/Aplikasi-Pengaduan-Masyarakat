...
die("Anda Belum Login"); //mencetak pesan keluar
   ...
   if($_SESSION['level']!="petugas") //mengetahui level  login untuk admin dam masuk ke halaman petugas
  {
    die("anda bukan petugas"); //mencetak pesan keluar/peringatan
  }
?>
...
<body id="page-top"> <!--pengaturan letak Isi dari sebuah dokumen HTML yang akan ditampilkan pada halaman berada di bagian atas-->
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Dashboard -->
      <li class="nav-item">
        <a class="nav-link" href="petugas.php"> <!--menghubungkan ke link -->
      ...
      <!-- Nav Item - Charts -->
      <li class="nav-item">
        <a class="nav-link" href="?url=verivikasi_pengaduan">
          <i class="fas fa-edit"></i><!--simbol-->
          <span>Verivikasi Pengaduan</span></a><!--isi dari verivikasi pengaduan-->
      </li>

  <!-- Nav Item - Tables -->
       <li class="nav-item">
        <a class="nav-link" href="helpp.html" target="_blank">  <!--link untuk menuju ke lihat pengaduan-->
