            ...
            <!--Judul Untuk Halaman Cetak Masyarakat-->
              ...
              <div class="table-responsive"> <br> <br>
                ...
                require '../koneksi.php'; //menyambungkan ke data koneksi
                 $sql=mysqli_query($koneksi,"select * from masyarakat"); //untuk mengirimkan perintah SQL ke server MySQL untuk melakukan aktivitas CRUD , menggunakan mysqli karena menggunakan mysql7
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="login.html">Logout</a>     <!--tombol logout-->
        </div>
      </div>
    </div>
  </div>
