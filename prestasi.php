...
Riwayat Prestasi <!--Isi dari sebuah dokumen HTML yang akan ditampilkan pada halaman berada di bagian atas-->
</div>
<div class="card-body">
...
<label>Kegiatan</label> <!--  penamaan dari sebuah halaman untuk isi dari nik  -->
<input type="text" name="" value=""class="form-control">
</div>

<div class="form-group cols-sm-6">
<label>Tahun</label> <!--  penamaan dari sebuah halaman untuk isi dari nik  -->
<input type="text" name="" value=""class="form-control">
</div>

<div class="form-group cols-sm-6">
<label>tempat</label> <!--  penamaan dari sebuah halaman untuk isi dari nik  -->
<input type="text" name="" value=""class="form-control">
</div>

<div class="form-group cols-sm-6">
<label>deskripsi</label> <!--  penamaan dari sebuah halaman untuk isi dari nik  -->
<input type="text" name="" value=""class="form-control">
</div>

<div class="form-group cols-sm-6">
<label>kep/piagam</label> <!--  penamaan dari sebuah halaman untuk isi dari nik  -->
<input type="text" name="" value=""class="form-control">
</div>
