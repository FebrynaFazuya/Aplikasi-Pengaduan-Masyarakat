...
<body id="page-top"> <!--pengaturan letak Isi dari sebuah dokumen HTML yang akan ditampilkan pada halaman berada di bagian atas-->
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <!--Judul Untuk Halaman Cetak pengaduan-->
             <h3 class="m-0 font-weight-bold text-secondary" align="center">Pemerintah Kota Magelang</h3>
              ...
              <div class="table-responsive"> <br> <br>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  $sql=mysqli_query($koneksi, "select * from pengaduan"); //untuk mengirimkan perintah SQL ke server MySQL untuk melakukan aktivitas CRUD , menggunakan mysqli karena menggunakan mysql7
