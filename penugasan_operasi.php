...
<!-- membuat judul dari sebuah halaman-->
  <title>Riwayat Penugasan Operasi</title>
...
Riwayat penugasan operasi  <!--Isi dari sebuah dokumen HTML yang akan ditampilkan pada halaman berada di bagian atas-->
</div>
<div class="card-body">
...
<label>Nama Operasi</label> <!--  penamaan dari sebuah halaman untuk isi dari nik  -->
