...
<!-- membuat judul dari sebuah halaman-->
  <title>Riwayat Kepangkatan</title>
...
Riwayat Kepangkatan  <!--Isi dari sebuah dokumen HTML yang akan ditampilkan pada halaman berada di bagian atas-->
</div>
<div class="card-body">
...
<div class="form-group cols-sm-6">
<label>Nomor Skep/Sprin/ST/TDG</label> <!--  penamaan dari sebuah halaman untuk isi dari nik  -->
<input type="text" name="" value=""class="form-control">
</div>
