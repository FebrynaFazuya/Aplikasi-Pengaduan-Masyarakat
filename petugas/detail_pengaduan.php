...
<input type="text" name="tgl_pengaduan" value="<?php echo $data ['tgl_pengaduan']; ?>"class="form-control"readonly><!--untuk menghubungka ke database dan file foto agar dapat ditampilkan ke halaman-->
</div>
