...
<!-- membuat judul dari sebuah halaman-->
  <title>Riwayat Tanda Jasa</title>
...
Riwayat Tanda Jasa  <!--Isi dari sebuah dokumen HTML yang akan ditampilkan pada halaman berada di bagian atas-->
</div>
<div class="card-body">
...
<label>Tanda Kehormatan Negara</label> <!--  penamaan dari sebuah halaman untuk isi dari nik  -->
