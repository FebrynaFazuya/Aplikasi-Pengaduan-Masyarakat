...
$id=$_GET['id']; //mengambil nilai id yang tersimpan di server database
  ...
  $sql = mysqli_query($koneksi,"delete from tanggapan where id_tanggapan='$id'"); //untuk mengirimkan perintah SQL ke server MySQL untuk melakukan aktivitas CRUD , menggunakan mysqli karena menggunakan php 7
  ...
  if ($sql) //untuk mengetes suatu kondisi 
  {
  	...
  	<script type="text/javascript"> //untuk membungkus suatu perintah
  		...
  		window.location='admin.php?url=lihat_tanggapan'; //kembali ke halaman lihat tanggapan
