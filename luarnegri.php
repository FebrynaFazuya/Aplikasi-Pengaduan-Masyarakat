...
<!-- membuat judul dari sebuah halaman-->
  <title>Riwayat Penugasan Luar Negri</title>
...
Riwayat Penugasan Luar Negri  <!--Isi dari sebuah dokumen HTML yang akan ditampilkan pada halaman berada di bagian atas-->
</div>
<div class="card-body">
...
<label>Macam Tugas</label> <!--  penamaan dari sebuah halaman untuk isi dari nik  -->
...
<div class="form-group cols-sm-6">
<label>Negara </label> <!--  penamaan dari sebuah halaman untuk isi dari nik  -->
<input type="text" name="" value=""class="form-control">
</div>

<div class="form-group cols-sm-6">
<label>Prestasi</label> <!--  penamaan dari sebuah halaman untuk isi dari nik  -->
<input type="text" name="" value=""class="form-control">
</div>
