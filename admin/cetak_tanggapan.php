            ...
            <!--Judul Untuk Halaman Cetak Masyarakat-->
              ...
              <div class="table-responsive"> <br> <br>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  $sql=mysqli_query($koneksi, "select * from tanggapan"); //untuk mengirimkan perintah SQL ke server MySQL untuk melakukan aktivitas CRUD , menggunakan mysqli karena menggunakan mysql7
